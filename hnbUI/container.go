...
// func (container *Container) AddChild(child hnbCore.IEntity) {
...
// func (container Container) GetLayoutSize() hnbMath.Vector {
// 	size := container.GetSize()

// 	layoutSize := hnbMath.Vector{
...
// func (container Container) calculateContentSize() hnbMath.Vector {
