...
func (layout *FlexLayout) SetSize(size hnbMath.Vector) {
	layout.Size = size
}

func (layout FlexLayout) GetPositions(elements []LayoutElement) []hnbMath.Vector {
...
func (layout FlexLayout) GetContentSize(elements []LayoutElement) hnbMath.Vector {
	size := hnbMath.Vector{}
